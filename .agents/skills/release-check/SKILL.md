...
wheel contains no Studio frontend or product-only modules, the FastAPI app has
only generic engine routes, and the README examples execute in deterministic
mode. Never publish from a checkout containing credentials or private product
artifacts.
