...
provider-neutral and independent of downstream product delivery.
...
contract tests for runtime or persistence changes. Do not import downstream
product modules here.
