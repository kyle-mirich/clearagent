...
class ProviderError(RuntimeError):
    """Normalized provider failure with request context and redacted details."""
...
class Usage(BaseModel):
    ...
    cost_usd: float | None = Field(
        default=None,
        validation_alias=AliasChoices("cost_usd", "cost"),
    )
...
class FakeProvider:
    """Deterministic in-memory provider for tests and offline examples."""
