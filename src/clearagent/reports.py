...
def _fenced(value: str, language: str = "") -> str:
    # Size the fence beyond any backtick run inside the content (CommonMark)
    # so embedded ``` sequences cannot close the block early and forge
    # subsequent report structure.
