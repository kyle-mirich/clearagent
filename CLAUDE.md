...
ClearAgent Engine repository.

- Keep product-facing routes, multi-tenant chat/source workflows, frontend
  code, deployment configuration, and credentials out of this repository.
